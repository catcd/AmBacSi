 ...
 */
public class DoctorDBHandler /*extends SQLiteOpenHelper*/ {
...
//
//    public DoctorDBHandler(Context _context, SQLiteDatabase.CursorFactory _factory) {
...
//        Cursor cursor = db.query(DoctorDBHandler.TABLE_NAME, null, null, null, null, null, null);
//        if (cursor != null) {
//            cursor.moveToFirst();
//        }
//        return cursor;
