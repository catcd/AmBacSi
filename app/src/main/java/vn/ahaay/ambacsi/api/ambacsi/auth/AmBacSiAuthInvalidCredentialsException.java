...
public class AmBacSiAuthInvalidCredentialsException extends AmBacSiAuthException {
    public static final String ERROR_CODE_SIGN_UP_INVALID_EMAIL = "The email address is malformed";
    public static final String ERROR_CODE_SIGN_UP_INVALID_USERNAME = "The username is invalid";
    public static final String ERROR_CODE_SIGN_IN_FAILED = "Sign in failed";
