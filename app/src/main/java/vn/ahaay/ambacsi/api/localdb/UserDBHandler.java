...
//
//    public UserDBHandler(Context _context, SQLiteDatabase.CursorFactory _factory) {
...
//        Cursor cursor = db.query(UserDBHandler.TABLE_NAME, null, null, null, null, null, null);
//        if (cursor != null) {
//            cursor.moveToFirst();
//        }
//        return cursor;
...
//        __start.setTime(Constant.FormatConstant.DATETIME_FORMAT.parse(_schedule.getString("start")));
//        row.put(COLUMN_START, __start.getTimeInMillis()/1000);
//
//        Calendar __end = Calendar.getInstance();
//        __end.setTime(Constant.FormatConstant.DATETIME_FORMAT.parse(_schedule.getString("end")));
