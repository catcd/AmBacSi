...
import static com.ahay.ambacsi.api.ambacsi.Constant.UserGroupConstant.*;
...
public class SelectGroupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View __view = inflater.inflate(R.layout.fragment_select_group, container, false);
    ...
    @OnClick(R.id.userClick) void selectGroupUser() {
        if (mListener != null) {
            mListener.selectGroup(GROUP_USER);
        }
    }

    @OnClick(R.id.doctorClick) void selectGroupDoctor() {
        if (mListener != null) {
            mListener.selectGroup(GROUP_DOCTOR);
        }
    }

    @OnClick(R.id.clinicalCenterClick) void selectGroupClinicalCenter() {
        if (mListener != null) {
            mListener.selectGroup(GROUP_CLINICAL_CENTER);
        }
    }
