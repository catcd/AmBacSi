...
import com.ahay.ambacsi.api.ambacsi.profile.DoctorProfileChangeRequest;
...
public class CreateProfileDoctorFragment extends Fragment {
    ...
    @BindView(R.id.createDoctorUsername) EditText createDoctorUsername;
    @BindView(R.id.createDoctorEmail) EditText createDoctorEmail;
    @BindView(R.id.createDoctorFirstName) EditText createDoctorFirstName;
    @BindView(R.id.createDoctorLastName) EditText createDoctorLastName;
    @BindView(R.id.createDoctorGender) EditText createDoctorGender;
    @BindView(R.id.createDoctorDob) EditText createDoctorDob;
    @BindView(R.id.createDoctorIdCardNo) EditText createDoctorIdCardNo;
    @BindView(R.id.createDoctorHomeAddress) EditText createDoctorHomeAddress;
    @BindView(R.id.createDoctorExperienceYear) EditText createDoctorExperienceYear;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View __view = inflater.inflate(R.layout.fragment_create_profile_doctor, container, false);
    ...
    @OnClick(R.id.submit) void submit() {
        ...
        if (TextUtils.isEmpty(__firstName)) {
            ...
            createDoctorFirstName.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__lastName)) {
            createDoctorLastName.requestFocus();
            createDoctorLastName.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__genderString)) {
            createDoctorGender.requestFocus();
            createDoctorGender.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__dobString)) {
            createDoctorDob.requestFocus();
            createDoctorDob.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__idCardNo)) {
            createDoctorIdCardNo.requestFocus();
            createDoctorIdCardNo.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__homeAddress)) {
            createDoctorHomeAddress.requestFocus();
            createDoctorHomeAddress.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__experienceYear)) {
            createDoctorExperienceYear.requestFocus();
            createDoctorExperienceYear.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        }

        int __gender = __genderString.equals(getResources().getString(R.string.gender_male)) ? 0 :
                __genderString.equals(getResources().getString(R.string.gender_female))? 1 : 2;
    ...
    @OnClick(R.id.createDoctorGender) void selectGender() {
        ...
        // get checked item
        int checkedItem = 0;
        if (createDoctorGender.getText().toString().equals(getResources().getString(R.string.gender_male))) {
            checkedItem = 1;
        } else if (createDoctorGender.getText().toString().equals(getResources().getString(R.string.gender_female))) {
            checkedItem = 2;
        } else if (createDoctorGender.getText().toString().equals(getResources().getString(R.string.gender_other))) {
            checkedItem = 3;
        }
        // Specify the list array, the items to be selected by default (null for none),
        // and the listener through which to receive callbacks when items are selected
        builder.setSingleChoiceItems(R.array.gender_select, checkedItem,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface _dialogInterface, int _i) {
                        switch (_i) {
                            case 1:
                                createDoctorGender.setText(getResources().getString(R.string.gender_male));
                                break;
                            case 2:
                                createDoctorGender.setText(getResources().getString(R.string.gender_female));
                                break;
                            case 3:
                                createDoctorGender.setText(getResources().getString(R.string.gender_other));
                                break;
                            default:
    ...
    @OnClick(R.id.createDoctorDob) void selectDob() {
