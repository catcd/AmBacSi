...
public class CreateProfileUserFragment extends Fragment {
    ...
    @OnClick(R.id.submit) void submit() {
        ...
        if (TextUtils.isEmpty(__firstName)) {
            ...
            createUserFirstName.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__lastName)) {
            createUserLastName.requestFocus();
            createUserLastName.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__genderString)) {
            createUserGender.requestFocus();
            createUserGender.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        } else if (TextUtils.isEmpty(__dobString)) {
            createUserDob.requestFocus();
            createUserDob.setError(getResources().getString(R.string.create_profile_error_field_required));
            return;
        }
    ...
    @OnClick(R.id.createUserGender) void selectGender() {
        ...
        // get checked item
        int checkedItem = 0;
        if (createUserGender.getText().toString().equals(getResources().getString(R.string.gender_male))) {
            checkedItem = 1;
        } else if (createUserGender.getText().toString().equals(getResources().getString(R.string.gender_female))) {
            checkedItem = 2;
        } else if (createUserGender.getText().toString().equals(getResources().getString(R.string.gender_other))) {
            checkedItem = 3;
        }
        ...
        builder.setSingleChoiceItems(R.array.gender_select, checkedItem,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface _dialogInterface, int _i) {
                        switch (_i) {
                            case 1:
                                createUserGender.setText(getResources().getString(R.string.gender_male));
                                break;
                            case 2:
                                createUserGender.setText(getResources().getString(R.string.gender_female));
                                break;
                            case 3:
                                createUserGender.setText(getResources().getString(R.string.gender_other));
                                break;
                            default:
    ...
    @OnClick(R.id.createUserDob) void selectDob() {
